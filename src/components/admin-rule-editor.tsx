...
export function AdminRuleEditor({ rules, role, impactByRule }: { rules: Rule[]; role: string; impactByRule: Record<string, RuleImpact> }) {
  ...
  useDialogFocus(showDiff, diffDialogRef, () => setShowDiff(false));
