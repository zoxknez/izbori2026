...
export default async function AdminPage() {
  ...
  return <main className="mx-auto max-w-5xl px-5 py-12">
    ...
    <p className="mt-3 text-sm text-ink-dim">Prijavljen: <strong>{admin.email}</strong> · uloga: <strong>{admin.role}</strong></p>
    ...
    <div className="mt-8 grid gap-4 sm:grid-cols-[1fr_auto]">
      ...
      {hasPermission(admin.role as AdminRole, "publish") && <AdminPublishButton />}
    </div>
